...
int main(int argc, char *argv[])
{
    ...
    .Add(20, 2, NULVAL, 4, -9, "dB")
    .Add(21, 2, NULVAL, 3, 3, "dB")
    .Add(22, 2, NULVAL, 4, -12, "dB")
    .Add(23, 2, NULVAL, 3, -1, "dB")
    .Add(24, 2, NULVAL, 4, -6, "dB")
    ...
    .Add(20, 3, NULVAL, 4, -9, "dB")
    .Add(21, 3, NULVAL, 3, 3, "dB")
    .Add(22, 3, NULVAL, 4, -12, "dB")
    .Add(23, 3, NULVAL, 3, -1, "dB")
    .Add(24, 3, NULVAL, 4, -6, "dB")
    ...
    .Add(20, 4, NULVAL, 4, -9, "dB")
    .Add(21, 4, NULVAL, 3, 3, "dB")
    .Add(22, 4, NULVAL, 4, -12, "dB")
    .Add(23, 4, NULVAL, 3, -1, "dB")
    .Add(24, 4, NULVAL, 4, -6, "dB")
